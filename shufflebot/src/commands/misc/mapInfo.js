...
const roles = [
    guild.roles.cache.some(r => r.name === 'Tier 0'),
    guild.roles.cache.some(r => r.name === 'Tier 1'),
    guild.roles.cache.some(r => r.name === 'Tier 2'),
    guild.roles.cache.some(r => r.name === 'Tier 3'),
    guild.roles.cache.some(r => r.name === 'Tier 4'),
    guild.roles.cache.some(r => r.name === 'Tier 5'),
    guild.roles.cache.some(r => r.name === 'Tier 6'),
    guild.roles.cache.some(r => r.name === 'Tier 7'),
    guild.roles.cache.some(r => r.name === 'Tier 8'),
    guild.roles.cache.some(r => r.name === 'Tier 9'),
    guild.roles.cache.some(r => r.name === 'Tier 10'),
    guild.roles.cache.some(r => r.name === 'Tier 11'),
    guild.roles.cache.some(r => r.name === 'Tier 12'),
]